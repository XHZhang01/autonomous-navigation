...
###  3.2. <a name='trajektory-publisher-(xiaoliang-and-runxin)'></a>Trajektory publisher (Xiaoliang and Runxin)
>  controller_pkg/src/traj_publisher.cpp    
...
###  3.5. <a name='use-ros-time-(runxin)'></a>Use ros-time (Runxin)
...
###  3.6. <a name='add-keyboard-control-packages-(runxin)'></a>Add keyboard control packages (Runxin)
>teleop
...
###  3.9. <a name='convert-the-depth-image-(runxin)'></a>Convert the depth image (Runxin)
> simulation/launch/point_cloud_convert.launch
...
###  3.10. <a name='move_base-and-the-optimization-of-parameters-(xiaoliang-and-runxin)'></a>Move_base and the optimization of parameters (Xiaoliang and Runxin)
> simulation/launch/move_base_kinect.launch
...
###  3.11. <a name='setup-octomap-(runxin)'></a>Setup Octomap (Runxin)
...
Although we have tried, we have not been able to achieve 3D navigation. We found several packages on github, but they either cannot be compiled or they cannot be ported to our project. We would be appreciated if other groups or Markus could show us how they implemented the 3D navigation.

##  5. <a name='external-code'></a>External code
* navigation/src/send_goal.cpp:
https://github.com/guyuehome/ros_basic_tutorials/blob/dfb8afac81929040ea659a40c03d1d41f2897b5f/mbot_navigation/mbot_navigation/src/move_test.cpp
